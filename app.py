...
# set implants: 'alacrity' or 'critical'
IMPLANT1 = 'alacrity'
IMPLANT2 = 'critical'
...
# set constraints
setAccuracy = m.sum([554*EnhancementsAccuracy, 130*AugmentsAccuracy, 554*EarpiecesAccuracy, 264*StimsAccuracy])
setAlacrity = m.sum([554*EnhancementsAlacrity, 130*AugmentsAlacrity, 554*EarpiecesAlacrity, 577*Implants1Alacrity, 577*Implants2Alacrity])
setCritical = m.sum([554*EnhancementsCritical, 130*AugmentsCritical, 554*EarpiecesCritical, 577*Implants1Critical, 577*Implants2Critical, 41*CrystalsCritical])
...
# goal:
m.set_multi_objective('min', [264*StimsAccuracy + 554*EnhancementsAccuracy + 130*AugmentsAccuracy + 554*EarpiecesAccuracy, 554*EnhancementsAlacrity + 130*AugmentsAlacrity + 554*EarpiecesAlacrity + 577*Implants1Alacrity + 577*Implants2Alacrity])
